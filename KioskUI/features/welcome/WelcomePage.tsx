...
export const WelcomePage: React.FC<WelcomePageProps> = ({
  ...
  const isMicDisabled =
    turnState === "PROCESSING" || turnState === "SYSTEM_RESPONDING";
  ...
  const ManualMode = () => (
    <div
      className={`flex flex-col items-center justify-center h-full w-full max-w-4xl mx-auto p-6 ${fade}`}
    >
    ...
    <div className="h-screen w-full flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center relative z-10 min-h-0 w-full">
        ...
        <motion.div
          ...
          style={{
            ...
            fontWeight: 900,
            background:
              "linear-gradient(135deg, #977DFF 0%, #c4b5fd 50%, #977DFF 100%)",
        ...
        {/* Hidden text for smoke test assertion */}
        <div className="sr-only">Welcome</div>
      ...
      <div className="flex-none w-full pb-12 px-6 flex flex-col items-center gap-8 z-20">
        ...
        <div className="relative group">
          ...
          <button
            className={`relative flex items-center justify-center w-24 h-24 rounded-full transition-all duration-200 active:scale-95 shadow-lg ${
              getAgentState() === "listening"
