...
export const BookingCollectPage: React.FC = () => {
  ...
  // Calculate progress
  const filledCount = REQUIRED_SLOTS.filter(
    (s) => bookingSlots[s] !== null && bookingSlots[s] !== undefined,
  ).length;
      ...
      <div className="flex-1 flex flex-col p-8 max-w-[60%]">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-white/50 mt-1">
            Speak naturally — I'll handle the details
          </p>
        </div>
      ...
      <div className="w-[40%] bg-slate-800/50 border-l border-slate-700/50 p-8 flex flex-col">
        ...
        <div className="mb-6">
          <div className="flex justify-between text-xs text-white/50 mb-2">
            ...
            <span>
              {filledCount}/{REQUIRED_SLOTS.length} details
            </span>
          </div>
        ...
        <div className="space-y-3 flex-1">
          {Object.entries(SLOT_LABELS).map(([key, label]) => {
            ...
            if ((key === "nights" || key === "totalPrice") && !isFilled)
              return null;
            ...
            return (
              ...
              >
                ...
                <div
                  className={`mt-1 text-sm ${isFilled ? "text-white" : "text-white/20"}`}
                >
                  {isFilled
                    ? key === "totalPrice"
