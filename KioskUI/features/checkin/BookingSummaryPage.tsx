      ...
      >
        ...
        <div className="bg-slate-800/60 border border-slate-700/50 rounded-2xl p-6 space-y-4">
          ...
          <div className="flex justify-between items-center">
            ...
            <span>
              {bookingSlots.adults || "—"} adult
              {bookingSlots.adults !== 1 ? "s" : ""}
              {bookingSlots.children
                ? `, ${bookingSlots.children} child${bookingSlots.children !== 1 ? "ren" : ""}`
                : ""}
            </span>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <span>
              {bookingSlots.nights || "—"} night
              {bookingSlots.nights !== 1 ? "s" : ""}
            </span>
          </div>
          ...
          <div className="flex justify-between items-center border-t border-slate-700/30 pt-4">
            ...
            <span className="text-2xl font-semibold text-cyan-400">
              ₹
              {bookingSlots.totalPrice
                ? bookingSlots.totalPrice.toLocaleString()
                : "—"}
            </span>
          </div>
        </div>
